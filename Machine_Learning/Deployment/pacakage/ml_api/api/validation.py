...
def _filter_error_rows(errors: dict,
    ...
    indecies = errors.keys()
     # delete them in reverse order so that you don't
     # throw off the subsequent iindecies.
...
def validate_input(input_data):
    ...
    # convert syntax error filed names (beginning with numebers)
