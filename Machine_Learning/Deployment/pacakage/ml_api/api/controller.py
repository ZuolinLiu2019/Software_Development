from flask import Buleprint, request, jsonify
from regression_model.predict import make_prediction
from regression_model import __version__ as __version
from neural_network_model.import make_single_prediction
import os
...
@prediction_app.route('/v1/prediction/regression', methods=['POST'])
def predict():
...
@prediction_app.route('/predict/classifier', method=['POST'])
def predict_image():
    if request.method == 'POST':
